...
Page({
    ...
    getFromDetailFromStorage() {
        const fromDetail = tt.getStorageSync('fromDetail')
        if(fromDetail) {
            this.setData({
                fromDetail
            })
    ...
    getEditInvoiceDetailFromStorage() {
        const editInvoiceDetail = tt.getStorageSync('editInvoiceDetail')
    ...
    getInvoiceDetailFromStorage() {
        const invoiceDetail = tt.getStorageSync('invoiceDetail')
        if(invoiceDetail) {
            const arr = ['01', '04', '08', '10', '11']
    ...
    onShow() {
        var animationImg = tt.createAnimation({
            duration: 250,
            timeFunction: 'linear',
        ...
        var animationTopList = tt.createAnimation({
            duration: 250,
            timeFunction: 'linear',
        })
            ...
            success: res => {
                ...
                if(res.statusCode === 200) {
                    if(res.data && res.data.length) {
                        ...
                        var accountbookIdStorage = tt.getStorageSync('accountbookId')
