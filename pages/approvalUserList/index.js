...
Page({
    ...
    getSearchUserList() {
        this.setData({
            searchUserList: tt.getStorageSync('searchUserList')
        })
    },
    onShow() {
    ...
    getUserList() {
        const userList = tt.getStorageSync('userList')
        this.setData({
            userList
        })
    },
    getSelectedIndex() {
        return tt.getStorageSync('nodeIndex')
    },
    getStorageUserList() {
    ...
    removeUser(e) {
        ...
        tt.setStorageSync('selectedUsers', selectedUsers)
        this.onShow()
    },
    checkboxChange(e) {
    ...
    goBack() {
        ...
        const prevDelta = tt.getStorageSync('delta')
        tt.navigateBack({
