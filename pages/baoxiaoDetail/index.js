...
Page({
  ...
  onLoad() {
    ...
    const initBaoxiaoDetail = tt.getStorageSync('initBaoxiaoDetail');
    const baoxiaoDetail = tt.getStorageSync('baoxiaoDetail');
  ...
  getSubjectIdFromStorage() {
    ...
    if (!!subject && subject !== null) {
      this.setData({
        baoxiaoDetail: { ...this.data.baoxiaoDetail,
          selectedAuxpty: null,
  ...
  setSelectedAuxpty(auxpty) {
    this.setData({
      baoxiaoDetail: { ...this.data.baoxiaoDetail,
        selectedAuxpty: { ...this.data.baoxiaoDetail.selectedAuxpty,
          [auxpty.auxptyId]: {
            id: auxpty.id,
            name: auxpty.name,
  ...
  addDetail() {
    ...
    if (validSuccess) {
      ...
      this.setData({
        ocrList: [],
        baoxiaoDetail: tt.getStorageSync('initBaoxiaoDetail')
      });
    }
  },
      ...
      success: res => {
        ...
        if (res.data.success) {
          ...
          tt.setStorage({
            ...
            success: res => {
              tt.setStorageSync('extraBaoxiaoDetail', this.data.baoxiaoDetail);
              tt.navigateTo({
